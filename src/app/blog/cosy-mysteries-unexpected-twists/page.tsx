      ...
      <main className="min-h-screen bg-background">
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p>
              The ebook versions of them are available for free. My main novel, The Quest for Immortality is available in PDF format free of charge right <Link href="https://www.janicewee.com/Emunah/the-quest-for-immortality-full.pdf" className="text-primary hover:underline">here</Link>.
            </p>
